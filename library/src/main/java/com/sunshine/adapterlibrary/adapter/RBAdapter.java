 ...
 */
public class RBAdapter<T> extends RecyclerView.Adapter<RViewHolder> implements RVBAdapter<RecyclerView.Adapter<RViewHolder>> {
    ...
    private Converter<? super T> mConverter;
    ...
    @Override
    public RecyclerView.Adapter<RViewHolder> getAdapter() {
        return this;
    }
